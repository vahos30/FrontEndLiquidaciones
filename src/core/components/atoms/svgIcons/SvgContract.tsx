...
interface SvgContractProps {
    index: string;
    tooltip?: string;
}

export const SvgContract: React.FC<SvgContractProps> = ({ index, tooltip = "Ingresar total entregado" }) => (
    <>
        <svg
            data-testid="svg-contract"
            data-tip={tooltip}
            data-for={`tooltip-contract-${index}`}
